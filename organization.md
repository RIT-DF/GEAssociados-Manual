...
preencher os dados básicos da sua organização. Esses dados são usados em comunicações, recibos e
...
![Tela de Configurações da Organização](assets/img/organization-form.png)
*Tela de Configurações preenchida com dados do GEJA.*

## Campos disponíveis

- **Nome** (obrigatório) — nome completo da organização, como aparece em comunicações.
